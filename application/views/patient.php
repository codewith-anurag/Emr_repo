  ...
  <section class="box">
    ...
    <!-- <li><a href="<?php //echo base_url().'insurance/download_excel'; ?>"> -->
          ...
          <td>
            ...
            <input onkeyup="patientlist_search()" id="patient_searchid" style="padding-left: 3em; padding-right: 3em; width: 100%; height: 100%; padding-bottom: 4px; padding-top: 8px; border: 1px solid #f7f8f9;" maxlength="100" class="form-control" placeholder="search by first name , last name , email and phone" title="search by first name , last name , email and phone" >
...
<td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><?php echo date('d/m/Y',strtotime($patient->create_date)); ?></td>
            ...
            <td>
              <?php //echo ($patient->sex=='Male')?'M':"F"; ?> <?php //echo date('d/m/Y',strtotime($patient->date_of_birth)); ?></td> -->
                ...
                </td><!--<span style="color:green" class="btn btn-default"><?php //echo ($patient->status=='1')?'Active':'Inactive'; ?></span>-->
                <td class="pt-15">
                    <div class="btn-group" style="float: right;display: flex;">
                      ...
                      <a href="#" onclick="patient_info('<?php echo $patient->id; ?>')" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-eye"></i></a>
                      <a href="<?php echo base_url("patient/edit/$patient->id") ?>" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url("patient/delete/$patient->id") ?>" class="btn btn-xs btn-danger icon-box" onclick="return confirm('<?php echo display('are_you_sure') ?>')" style="margin-right:10px;"><i class="fa fa-trash"></i></a>
