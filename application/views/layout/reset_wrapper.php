                      ...
                      <?php echo form_open('dashboard/reset_password','id="loginForm" novalidate'); ?>
                        ...
                        <div class="row">
                            <div class="login-form-header" style="text-align: center;">
                                ...
                                <h4><small>Please enter your emr.visionaryhealthservices.com account Email Id and click Reset Password. Wait a few moments and check your Email. (Check your Spam or Junk Mail box also!)</small></h4>
                            </div>
                            <div class="col-xs-12">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    ...
                                    <button id="getpassword" class="icon-color btn btn-default" >Reset Password</button>
                                    <button id="go-back" class="icon-color btn btn-default" onclick="goBack()">Back</button>
                                </div>
                            </div>
                        </form>
                      </div>
