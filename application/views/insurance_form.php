...
<div class="col-lg-12 p-0">
  <?php echo form_open_multipart('insurance/create','class="form-inner"') ?>
  ...
  <div class="row ml-10 mr-10">
    <div class="col-12 col-md-6 form-group">
                            ...
                            <input type="text" name="payer_name" value="<?php echo $insurance->payer_name; ?>" class="form-control text-field" id="add1" placeholder="Payer list">
                            <!-- <i class="fa fa-search pos-icon"></i> -->
                          </div>
                           <div class="col-12 col-md-6 form-group">
  ...
  <div class="row  ml-10 mr-10">
    ...
    <div class="col-12 col-md-4 form-group">
      ...
      <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="number" onkeydown="return event.keyCode !== 69" value="<?php echo $insurance->subscribers_ssn; ?>" name="subscribers_ssn" class="form-control text-field" id="subscribers_ssn">
                          </div>
