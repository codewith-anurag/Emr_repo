        ...
        <tr>
          ...
          <td width="15%">
            ...
            <div style="display: flex;">
                ...
                <a  onclick="return medication_report_pdf();">
                 ...
                 <button id="new" onclick="return medication_report_excel();" class="btn btn-default " style="width: 90%;margin-right: 11px;margin-top: 5px;" data-toggle="dropdown" data-hover="dropdown">
          ...
          <td>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control medication_report_medication text-field select2" name="medication">

                            <option value="">Select Medication</option>

                            <?php

                                foreach($drug_name as $drug_name_list){

                            ?>

                                <option value="<?php echo $drug_name_list->drug_name;?>"><?php echo $drug_name_list->drug_name;?></option>
               ...
               <div class="col-lg-3">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" name="from_date" class="form-control text-field" id="medication_report_from_datetime" placeholder="From Date">          
                ...
                <div class="col-lg-3">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" name="to_date" class="form-control text-field" id="medication_report_to_datetime" placeholder="To Date">          
               ...
               <div class="col-lg-3">
                   ...
                   <div class="form-group">                        
                        ...
                        <button id="new" class="btn btn-default" onclick="return medication_report_search();"><i class="fa fa-search"></i></button>    
      ...
      <table class="table table-patient">
        ...
        <thead>
            ...
            <tr>
                ...
                <th width="30%" class="text-center">Medication</th>
...
<script>    
 ...
 $(document).ready(function() {
        ...
        $('#medication_report_from_datetime').datepicker({
        ...
        $('#medication_report_to_datetime').datepicker({
    ...
    function medication_report_search(){

       var BASE_URL = '<?php echo base_url(); ?>';

       var medication = $(".medication_report_medication").val();

       var from_date = $("#medication_report_from_datetime").val();

       var to_date = $("#medication_report_to_datetime").val();
          ...
          $("#padd").empty();
           ...
           $.ajax({
                ...
                url: BASE_URL+"medication_report/medication_report_search",

                data: 'medication='+medication+'&from_date='+from_date+'&to_date='+to_date,
    ...
    function medication_report_pdf(){
        ...
        if ($(".medication_report_medication").val() !="") {
        ...
        if ($("#medication_report_from_datetime").val()!="") {
        ...
        if ($("#medication_report_to_datetime").val()!="") {
        ...
        window.location.href='<?php echo base_url(); ?>'+'medication_report/medication_report_pdf/'+medication+'/'+from_date+'/'+to_date

    }

    function medication_report_excel(){
        if ($(".medication_report_medication").val() !="") {
        ...
        window.location.href='<?php echo base_url(); ?>'+'medication_report/download_excel/'+medication+'/'+from_date+'/'+to_date
