 ...
 <div class="col-12 col-md-6 form-group">
  ...
  <div class="row  ml-10 mr-10">
     <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" onchange="effective()" name="effective_from" value="<?php echo $insurance->effective_from; ?>" class="form-control text-field" id="efdate" placeholder="effective from">
                          </div>
                           <div class="col-12 col-md-4 form-group">
                            <label>EFFECTIVE TO</label>
                            <input type="text" onchange="effective()"  name="effective_to" value="<?php //echo ($insurance->effective_to!='')?$insurance->effective_to:''; ?>" class="form-control text-field" id="etdate" placeholder="effective to">
                      ...
                      <header class="panel_header">
                        ...
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" name="subscribers_dob" value="<?php echo $insurance->subscribers_dob; ?>" class="form-control text-field" id="date">
                          </div>
                               <div class="col-12 col-md-4 form-group">
                        <label>SEX</label>
