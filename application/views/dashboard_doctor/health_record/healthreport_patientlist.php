  ...
  <section class="box">
    ...
    <!-- <li><a href="<?php //echo base_url().'insurance/download_excel'; ?>"> -->
          ...
          <td>
            ...
            <input onkeyup="health_record_patient_search()" id="patient_searchid" style="padding-left: 3em; padding-right: 3em; width: 100%; height: 100%; padding-bottom: 4px; padding-top: 8px; border: 1px solid #f7f8f9;" maxlength="100" class="form-control" placeholder="search by first name , last name , email and phone" title="search by first name , last name , email and phone" >
...
<td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><?php echo date('d/m/Y',strtotime($patient->create_date)); ?></td>
              ...
              <td class="pt-15"><div class="btn-group" style="float: right;display: flex;">
                ...
                <a href="<?php echo base_url('dashboard_doctor/health_record/health_report/create/'.$patient->id); ?>" class="btn btn-xs icon-box" style="margin-right:10px; display: block;  margin: 0 auto;">Health Record</a>
                <a href="<?php echo base_url("dashboard_doctor/patient/patient/familymember/$patient->id") ?>" class="btn btn-xs icon-box" style="margin-right:10px;">Family Member</a>
