...
<div class="col-lg-12 white-box" style="width: 100%;margin-right: 2%;min-height: 850px;">
  <section class="box">
    ...
    <!-- <li><a href="<?php //echo base_url().'patient/download_excel'; ?>"> -->
                  <button id="new" onclick="window.location.href='<?php echo base_url()."dashboard_doctor/patient/patient/download_excel"; ?>'" class="btn btn-default dropdown-toggle" style="width: 90%;margin-right: 11px;" data-toggle="dropdown" data-hover="dropdown">
                  <span class="fa fa-file-excel-o"></span>
                  &nbsp;&nbsp;Demographic</span>
                </button>
              <!-- </a> -->
    ...
    <!-- <li><a href="<?php //echo base_url().'insurance/download_excel'; ?>"> -->
                 <button onclick="window.location.href='<?php echo base_url()."dashboard_doctor/insurance/insurance/download_excel"; ?>'"   id="new" class="btn btn-default dropdown-toggle" style="width: 90%;margin-right: 11px;" data-toggle="dropdown" data-hover="dropdown">
                  <span class="fa fa-file-excel-o"></span>
                  &nbsp;&nbsp;Insurance</span>
                </button>
              <!-- </a> -->
          ...
          <td>
            ...
            <input onkeyup="patient_search()" id="patient_searchid"  style="padding-left: 3em; padding-right: 3em; width: 100%; height: 100%; padding-bottom: 4px; padding-top: 8px; border: 1px solid #f7f8f9;" maxlength="100" class="form-control"  placeholder="search by first name , last name , email and phone" title="search by first name , last name , email and phone"  >
    ...
    <div class="col-lg-12" style="min-height: 850px;">
      <table class="table table-patient">
        ...
        <tbody id="padd">
          ...
          <td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><?php echo date('d/m/Y',strtotime($patient->date_of_birth)); ?> </td>
          <td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><?php echo $patient->sex; ?></td>
          ...
          <td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><span style="color:green" class="btn btn-default"><?php echo ($patient->status=='1')?'Active':'Inactive'; ?></span></td>
