...
<div class="col-lg-12 p-0">
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      ...
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-2 form-group">
          <label>PREFIX</label>
          <!-- <input type="text" name="prefix" class="form-control text-field" value="<?php //cho $patient->prefix ?>" id="Prefix"> -->
        ...
        <div class="col-12 col-md-4 form-group">
          ...
          <input type="text" name="lname" class="form-control text-field" id="lname" value="<?php echo $patient->lname ?>" id="lname" placeholder="Last Name">
        </div>
      </div>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-2 form-group">
      ...
      <div class="row ml-10 mr-10 mb-10">
        ...
        <div class="col-12 col-md-3 form-group">
          ...
          <input type="text" name="date_of_birth" value="<?php echo $patient->date_of_birth ?>" data-date-format='yyyy-mm-dd' class="form-control text-field" id="dob">
        </div>
        <div class="col-12 col-md-3 form-group">
          <label>DATE OF DEATH</label>
          <?php  if(isset($patient->id)){ ?>
          <input type="text" name="dod" value="<?php echo $patient->dod; ?>" data-date-format='yyyy-mm-dd' class="form-control text-field" id="dods">
          <?php }else{ ?>
          <input type="text" name="dod" value=""  data-date-format='yyyy-mm-dd' class="form-control text-field" id="dod">
          <?php       } ?>
        </div>
        <div class="col-12 col-md-2 form-group">
      ...
      <div class="row ml-10 mr-10">
        ...
        <div class="col-12 col-md-4 form-group">
          ...
          <input type="number" onkeydown="return event.keyCode !== 69" name="workphone" value="<?php echo $patient->workphone ?>" class="form-control text-field" id="phone" placeholder="">
        </div>
        <div class="col-12 col-md-3 form-group">
          <label></label>
          <input type="number" onkeydown="return event.keyCode !== 69" name="ext" value="<?php echo $patient->ext ?>" class="form-control text-field" id="phone" placeholder="Ext">
        </div>
      </div>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-6 form-group">
          <label>ADDRESS</label>
          <input type="text" name="address1" value="<?php echo $patient->address1 ?>" class="form-control text-field" id="address1" placeholder="Street address 1">
        </div>
        <div class="col-12 col-md-6 form-group">
          <label></label>
      ...
      <div class="row ml-10 mr-10">
        ...
        <div class="col-12 col-md-4 form-group">
          <input type="text" name="country" value="<?php echo $patient->country ?>" class="form-control text-field" id="country" placeholder="country">
        </div>
        <div class="col-12  col-md-2 form-group">
      ...
      <div class="row m-0">
        <div class="col-12">
          ...
          <!-- <a href="#" class="insurance ml-10"> <span>Print Active Insurance</span></a> -->
        </div>
      </div>
      <div class="row ml-10 mr-10">
        <!-- <div class="col-12 col-md-7 form-group">
      ...
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-6 form-group">
          <label>ADDRESS</label>
          <input type="text" name="guarantor_address1" value="<?php echo $patient->guarantor_address1 ?>" class="form-control text-field" id="add1" placeholder="Street Address ">
        </div>
        <div class="col-12 col-md-6 form-group">
          <label></label>
      ...
      <div class="row ml-10 mr-10">
        ...
        <div class="col-12 col-md-4 form-group">
          <input type="text" name="guarantor_country" value="<?php echo $patient->guarantor_country ?>" class="form-control text-field" id="add2" placeholder="country">
        </div>
        <div class="col-12 col-md-2 form-group">
    ...
    <div class="row ml-10 mr-10 mb-10">
      ...
      <div class="col-12 col-md-3 form-group">
        ...
        <input type="text" data-date-format='yyyy-mm-dd' value="<?php echo $patient->immunization_effective_date ?>" name="immunization_effective_date" class="form-control text-field edate" id="date">
      </div>
      <div class="col-12 col-md-6 form-group">
      ...
      <?php if(!empty($patient->picture)) {  ?>
        <div class="row form-row">
          <div class="col-xs-12">
            ...
            <div class="col-xs-8">
                <img src="<?php echo base_url($patient->picture) ?>" alt="Picture" class="img-thumbnail" style="width:150px;">
  ...
  <!-- image Crope -->
    ...
    <div class="text-center mb-10 mt-10">
      ...
      <a href="<?php echo base_url().'dashboard_doctor/patient/patient'; ?>"><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
    ...
    <section>
      ...
      <div class="row  ml-10 mr-10">
        ...
        <div class="col-12 col-md-4 form-group">
          ...
          <div id="effectivetime" style="display:none;"> Effective To Date Should Not Be Less Than Effective From Date
          </div>
        </div>
        <div class="col-12 col-md-4 form-group">
      ...
      <div  id="employer" class="collapse">
        ...
        <div class="row ml-10 mr-10">
          ...
          <div class="col-12 col-md-6 form-group">
            <label></label>
            <input type="text" name="employer_country" class="form-control text-field" id="add2" placeholder="Address 2">
          </div>
        </div>
        <div class="row ml-10 mr-10 mb-10">
          <div class="col-12 col-md-6 form-group">
      ...
      <div  id="subscriber" class="collapse">
        ...
        <div class="row ml-10 mr-10">
          <div class="col-12 col-md-6 form-group">
            ...
            <input type="text"  name="subscribers_dob" class="form-control text-field dates" id="date">
          </div>
          <div class="col-12 col-md-6 form-group">
            <label>SEX</label>
        ...
        <div class="row ml-10 mr-10">
          ...
          <div class="col-12 col-md-6 form-group">
            <label></label>
            <input type="text" name="subscribers_country" class="form-control text-field" id="add2" placeholder="Address 2">
          </div>
        </div>
        <div class="row ml-10 mr-10 mb-10">
          <div class="col-12 col-md-6 form-group">
        ...
        <div class="row ml-10 mr-10">
          <div class="col-12 col-md-6 form-group">
            ...
            <input type="text" name="subscribers_primary_number" class="form-control text-field" id="phonenum">
          </div>
          <div class="col-12 col-md-4 form-group">
            <label></label>
...
var employer_country =  $("input[name=employer_country]").val();
...
var subscribers_country =  $("input[name=subscribers_country]").val();
...
$.ajax({
//dashboard_doctor/schedule/schedule/get_appoitmentlistallforcalenderblock
url: BASE_URL+"dashboard_doctor/insurance/insurance/creates",
...
'&effective_from='+effective_from+'&effective_to='+effective_to+'&relation_to_insured='+relation_to_insured+'&copay_type='+copay_type+'&copay_amount='+copay_amount+'&claim_number='+claim_number+'&notes='+notes+'&employer_name='+employer_name+'&employer_address1='+employer_address1+'&employer_country='+employer_country+'&city='+city+'&state='+state+'&zip='+zip+'&subscribers_fname='+subscribers_fname+'&subscribers_mname='+subscribers_mname+'&subscribers_lname='+subscribers_lname+
'&subscribers_dob='+subscribers_dob+'&subscribers_sex='+subscribers_sex+'&subscribers_ssn='+subscribers_ssn+'&subscribers_address1='+subscribers_address1+'&subscribers_country='+subscribers_country+'&subscribers_city='+subscribers_city+'&subscribers_state='+subscribers_state+'&subscribers_zip='+subscribers_zip+'&subscribers_primary_number='+subscribers_primary_number+'&subscribers_primary_ext='+subscribers_primary_ext+'&subscribers_secondary_number='+subscribers_secondary_number+
