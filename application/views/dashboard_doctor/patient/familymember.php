  ...
  <section class="box">
    <table class="table" style="border-bottom: 0.5px solid #c6c4c1;">
      <tbody>
        <tr>
          <td width="15%">
            <?php $patient_ID = $this->uri->segment(5) ?>
            <a href="<?php echo base_url("dashboard_doctor/patient/patient/create_familymember/".$patient_ID) ?>">
          ...
          <td>
            <div style="position: absolute;right:calc(100% - 28%); /*left: 1em; top: 0;*/ padding-top: 7px;" > <span id="searchButtonShow" class="text-primary hover icon-md fa fa-search" aria-hidden="true"  style="margin-left: 1px;"></span>
            </div>
            <input onkeyup="familymember_search()" id="patient_searchid" style="padding-left: 3em; padding-right: 3em; width: 100%; height: 100%; padding-bottom: 4px; padding-top: 8px; border: 1px solid #f7f8f9;" maxlength="100" class="form-control" placeholder="search by first name , last name , email and phone" title="search by first name , last name , email and phone" >
            ...
            <!-- <td>
                ...
                <td class="pt-15">
                    <div class="btn-group" style="float: right;display: flex;">
                      <!-- <a href="#" onclick="patient_info('<?php //echo $patient->patient_id; ?>')" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-eye"></i></a> -->
                      <a href="<?php echo base_url("dashboard_doctor/patient/patient/edit_familymember/$familymember->member_id/$familymember->patient_id") ?>" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url("dashboard_doctor/patient/patient/delete_familymember/$familymember->member_id/$familymember->patient_id")?>" class="btn btn-xs btn-danger icon-box" onclick="return confirm('<?php echo display('are_you_sure') ?>')" style="margin-right:10px;"><i class="fa fa-trash"></i></a>
