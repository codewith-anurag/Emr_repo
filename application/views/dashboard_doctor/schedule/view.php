...
<div class="tab-content">
                   ...
                   <div class="dropdown-container" style="height: 300px;">
                        <label class="dropdown-item border-bottom"><input class="mr-10 ml-10" id="select-all-n" type="checkbox" name="appointment_types" value="All"> All</label>
                ...
                <td><?php
                 ...
                 <?php
                          if($value->created_by_role=='1' || $value->created_by_role=='2'){
                                  $created_by = $this->db->select("*")->from("user")->where("user_id",$value->created_by)->where("user_role",$value->created_by_role)->get()->row();
    ...
    <div class="modal-content">
      ...
      <div class="row form-row">
        <div class="col-xs-12">
          <div class="form-group dis-flex  mb-0">
          <div class="col-xs-12">
            <b>Start Time:</b> <p style="display:inline-block;" id="fors_time"></p>
            </div>
          </div>
        </div>
      </div>
      <div class="row form-row">
        <div class="col-xs-12">
          <div class="form-group dis-flex  mb-0">
          <div class="col-xs-12">
            <b>End Time:</b> <p style="display:inline-block;" id="tos_time"></p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="col-12 form-group m-0">
                              ...
                              <input type="text"  name="patent_name"  required class="form-control text-field" id="patientPartyName" placeholder="Search patient name, DOB or SSN">  <!--onkeyup="search()" -->
...
<?php if($isadmin=='1'){ ?>
                 ...
                 <div class="row">
                          ...
                          <!-- <input list="browsers" name="bduration" id="browser">
                           ...
                           <label>Date</label>
                           <input type="text"  name="repeat_date"  id="repeat_date"  class="form-control text-field"  placeholder="Repeat Date">
                         </div>
                         </div>
                            <div class="row ">
                            <div class="col-12 form-group ml-10 mr-10">
