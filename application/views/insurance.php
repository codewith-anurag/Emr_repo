            ...
            <td>
              ...
              <td class="pt-15"> <?php echo $patient->status; ?>
                                ...
                                <td class="pt-15"><div class="btn-group" style="float: right;display: flex;">
                                  <a href="<?php echo base_url("insurance/print/$patient->insurance_u_id") ?>" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-print"></i></a>
                                        <a href="<?php echo base_url("insurance/edit/$patient->insurance_u_id") ?>" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                                        <a href="<?php echo base_url("insurance/delete/$patient->insurance_u_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a>
                  </div>
                                                  </td>
