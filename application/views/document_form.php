    ...
    <div class="col-sm-12">
        <div  class="panel panel-default thumbnail">
            ...
            <div class="panel-heading">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("patient/document") ?>"> <i class="fa fa-list"></i>  <?php echo display('document_list') ?> </a>
                </div>
            </div>
                        ...
                        <?php echo form_open_multipart('patient/document_form','class="form-inner" id="mailForm" ') ?>
                            ...
                            <div class="col-xs-12  padding-bottom-30 form-group">
                                <div class="text-left">
                                    ...
                                    <button  class="btn positive"><?php echo display('send') ?></button>
                                </div>
                            </div>
