  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <?php if(isset($loinc_code->loinc_code_id)){
        ?>
        <h2 class="title pull-left" id="form-title">Edit Loinc Code </h2>
        <?php }else{ ?>
        <h2 class="title pull-left" id="form-title">Add Loinc Code</h2>
        <?php }
        ?>
      </header>
      <?php echo form_open_multipart('dashboard_super/loinc_code/loinc_code/create','class="form-inner"') ?>
      <?php echo form_hidden('loinc_code_id',$loinc_code->loinc_code_id); ?>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          <label>Loinc Code<span class="imp-red">*</span></label>
          <input type="text" required name="loinc_code" class="form-control text-field" value="<?php echo $loinc_code->loinc_code ?>" id="loinc_code" placeholder="Loinc Code">
        </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."dashboard_super/loinc_code/loinc_code/"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
