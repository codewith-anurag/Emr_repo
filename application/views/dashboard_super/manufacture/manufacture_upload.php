...
<div class="col-lg-12 p-0">
  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      ...
      <?php echo form_open_multipart('dashboard_super/manufacture/manufacture/upload_manufacture','class="form-inner"') ?>
      
        <div class="row ml-10 mr-10">        
            <div class="col-12 col-md-3 form-group">
              <label>Manufacture File<span class="imp-red">*</span></label>
              <input type="file" required=""  name="manufacturefile" class=" text-field"  id="manufacturefile">
            </div>
        </div>
