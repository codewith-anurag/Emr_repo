  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <?php if(isset($manufacture->manufacture_id)){
        ?>
        <h2 class="title pull-left" id="form-title">Edit Manufacture </h2>
        <?php }else{ ?>
        <h2 class="title pull-left" id="form-title">Add Manufacture</h2>
        <?php }
        ?>
      </header>
      <?php echo form_open_multipart('dashboard_super/manufacture/manufacture/create','class="form-inner"') ?>
      <?php echo form_hidden('manufacture_id',$manufacture->manufacture_id); ?>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          <label>Manufacture<span class="imp-red">*</span></label>
          <input type="text" required name="manufacture" class="form-control text-field" value="<?php echo $manufacture->manufacture ?>" id="manufacture" placeholder="Manufacture">
        </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."dashboard_super/manufacture/manufacture/"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
