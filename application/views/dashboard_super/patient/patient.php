...
<div class="col-lg-12 white-box" style="width: 100%;margin-right: 2%;min-height: 850px;">
  <section class="box">
        ...
        <tr>
          ...
          <td width="30%">
            <!-- <ul style="display:flex;list-style-type:none;">
                <li>
                <a href="<?php //echo base_url().'dashboard_super/patient/patient/patient_report/'.$admin_id; ?>">
                  <button id="new" class="btn btn-default" style="width: 90%;margin-right: 11px;">
              ...
              <li>
              <a href="<?php //echo base_url().'dashboard_super/patient/patient/download_excel/'.$admin_id; ?>">
                <button id="new" class="btn btn-default" style="width: 90%;margin-right: 11px;">
    ...
    <!-- <li><a href="<?php //echo base_url().'patient/download_excel'; ?>"> -->
                  <button id="new" onclick="window.location.href='<?php echo base_url()."dashboard_super/patient/patient/download_excel/".$admin_id; ?>'" class="btn btn-default dropdown-toggle" style="width: 90%;margin-right: 11px;" data-toggle="dropdown" data-hover="dropdown">
                  <span class="fa fa-file-excel-o"></span>
                  &nbsp;&nbsp;Demographic</span>
                </button>
              <!-- </a> -->
    ...
    <!-- <li><a href="<?php //echo base_url().'insurance/download_excel'; ?>"> -->
                 <button onclick="window.location.href='<?php echo base_url()."dashboard_super/patient/insurance/download_excel/".$admin_id; ?>'"   id="new" class="btn btn-default dropdown-toggle" style="width: 90%;margin-right: 11px;" data-toggle="dropdown" data-hover="dropdown">
                  <span class="fa fa-file-excel-o"></span>
                  &nbsp;&nbsp;Insurance</span>
                </button>
              <!-- </a> -->
        ...
        <tbody id="padd">
          <?php   if (!empty($patients)) { ?>
                    ...
                    <tr style="border-bottom: 1px solid #ddd;" class="hovertr" >
                      ...
                      <td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><?php echo $patient->address1.' '.$patient->country.' '.$patient->city.' '.$patient->state.' '.$patient->zip; ?> <br>
                      <div style="display:flex; margin-top:15px;">
                        <span class="light-grey" style="width:50%;">M : <label style="color:#000;font-weight:400;"><?php echo $patient->mobile; ?></label></span>
                        <span class="light-grey ml-15" style="width:50%;">H : <label style="color:#000;font-weight:400;"><?php echo $patient->phone; ?></label></span>
                      </div>
                      </td>
                      <td onclick="patient_info('<?php echo $patient->patient_id; ?>')"><?php echo date('d/m/Y',strtotime($patient->create_date)); ?></td>
                      <td><div class="btn-group">
                      <select class="btn btn-default form-control" onchange="call('<?php echo $patient->patient_id; ?>',this.options[this.selectedIndex].value,'<?php echo $admin_id; ?>')">
                      ...
                      <a href="#" onclick="patient_info('<?php echo $patient->patient_id; ?>','<?php echo $admin_id; ?>')" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-eye"></i></a>
                      <a href="<?php echo base_url("dashboard_super/patient/patient/edit/$patient->id/$admin_id") ?>" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url("dashboard_super/patient/patient/delete/$patient->id/$admin_id") ?>" class="btn btn-xs btn-danger icon-box" onclick="return confirm('<?php echo display('are_you_sure') ?>')"><i class="fa fa-trash"></i></a>
                      </div>
                      </td>
                    </tr>
...
{
  var conStatus = confirm('Are you sure?');
  if(conStatus){
    $.ajax({
