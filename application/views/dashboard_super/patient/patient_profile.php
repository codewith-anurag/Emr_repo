            ...
            <div class="panel-body">
                ...
                <ul class="col-xs-12 nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation">
                        ...
                        <a href="#vitalsign" aria-controls="documents" role="tab" data-toggle="tab"><?php echo display('vital_sign') ?></a>
                ...
                <div class="col-xs-12 tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="vitalsign">
                                ...
                                <table width="100%" class="datatable table table-striped table-bordered table-hover">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo display('pulse') ?></th>

                                            <th><?php echo display('temperature') ?></th>

                                            <th><?php echo display('blood pressure') ?></th>
                                            <th><?php echo display('Weight(kg)') ?></th>
                                            <th><?php echo display('Rest.Rate(Breaths/min)') ?></th>
                                            <th><?php echo display('date') ?></th>
...
<?php// print_r($vital); ?>
                                        <?php if (!empty($vital)) { ?>
                                            ...
                                            <?php foreach ($vital as $v) { ?>

                                                <tr>

                                                    <td><?php echo $sl; ?></td>

                                                    <td><?php echo $v->patient_id; ?></td>

                                                    <td><?php echo $v->pulse; ?></td>
<td><?php echo $v->temperature.'-'.$v->temperature_a; ?></td>
<td><?php echo $v->blood_pressure_sytolic.'(sytolic)-'.$v->blood_pressure_diastolic.'(diastolic)-'.$v->blood_pressure_position.'(Sitting/Standing)'; ?></td>
<td><?php echo $v->weight; ?></td>
<td><?php echo $v->rest_rate; ?></td>
                                                    <td><?php echo date('d-m-Y',strtotime($v->created_date)); ?></td>
                                                    <td><?php echo date('H:i:s',strtotime($v->created_time)); ?></td>
