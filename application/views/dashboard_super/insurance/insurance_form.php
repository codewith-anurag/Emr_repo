...
<div class="col-lg-12 p-0">
  <?php echo form_open_multipart('dashboard_doctor/insurance/insurance/create','class="form-inner"') ?>
                    ...
                    <section>
                      <div class="row  ml-10 mr-10">
                         <div class="col-12 col-md-4 form-group">
                                              <?php $p_result = $this->db->select("*")->from("patient")->where("status",'1')->get()->result();
  ...
  <div class="row ml-10 mr-10">
    <div class="col-12 col-md-6 form-group">
                            ...
                            <input type="text" name="payer_name" value="<?php echo $insurance->payer_name; ?>" class="form-control text-field" id="add1" placeholder="Search payer list">
                            <i class="fa fa-search pos-icon"></i>
                          </div>
                           <div class="col-12 col-md-6 form-group">
                            <label>PLAN NAME AND TYPE<span class="imp-red">*</span></label>
                            <input type="text" name="plan_name_and_type" value="<?php echo $insurance->plan_name_and_type; ?>" class="form-control text-field" id="add1" placeholder="Search">
                            <i class="fa fa-search pos-icon"></i>
                          </div>
                          <div class="col-12">
 ...
 <div class="col-12 col-md-6 form-group">
  ...
  <div class="row  ml-10 mr-10">
     <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="date" name="effective_from" value="<?php echo $insurance->effective_from; ?>" class="form-control text-field" id="date" placeholder="effective from">
                          </div>
                           <div class="col-12 col-md-4 form-group">
                            <label>EFFECTIVE TO</label>
                            <input type="date" name="effective_to" value="<?php echo $insurance->effective_to; ?>" class="form-control text-field" id="date" placeholder="effective to">
                          </div>
                          <div class="col-12 col-md-4 form-group">
  ...
  <div class="row  ml-10 mr-10">
    ...
    <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" name="copay_amount" value="<?php echo $insurance->copay_amount; ?>" class="form-control text-field" id="amount" placeholder="$">
                          </div>
                           <div class="col-12 col-md-4 form-group">
                        ...
                        <div class="row ml-10 mr-10 mb-10">
                          ...
                          <div class="col-12 col-md-4 form-group">
                           ...
                           <div class="col-12 col-md-2 form-group">
                            <input type="text" name="zip" value="<?php echo $insurance->zip; ?>" class="form-control text-field" id="zip" placeholder="Zip">
                          </div>
                        </div>
                         <header class="panel_header">
      ...
      <div class="col-12 col-md-4 form-group">
                        ...
                        <div class="row ml-10 mr-10 mb-10">
                          <div class="col-12 col-md-6 form-group">
                           ...
                           <div class="col-12 col-md-2 form-group">
                            <input type="text" name="subscribers_zip" value="<?php echo $insurance->subscribers_zip; ?>" class="form-control text-field" id="zip" placeholder="Zip">
                          </div>
                        </div>
                        <div class="row ml-10 mr-10 mb-10 border-bottom">
                          <div class="col-12 col-md-4 form-group">
                            <label>SUBSCRIBER PRIMARY PHONE NUMBER</label>
                            <input type="text" name="subscribers_primary_number" value="<?php echo $insurance->subscribers_primary_number; ?>" class="form-control text-field" id="phonenum">
                          </div>
                          <div class="col-12 col-md-2 form-group">
                            <label></label>
                            <input type="text" name="subscribers_primary_ext" value="<?php echo $insurance->subscribers_primary_ext; ?>" class="form-control text-field" id="ext" placeholder="Ext">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <label>SECONDARY PHONE NUMBER</label>
                            <input type="text" name="subscribers_secondary_number" value="<?php echo $insurance->subscribers_secondary_number; ?>" class="form-control text-field" id="phonenum">
                          </div>
                          <div class="col-12 col-md-2 form-group">
                            <label></label>
                            <input type="text" name="subscribers_secondary_ext" value="<?php echo $insurance->subscribers_secondary_ext; ?>" class="form-control text-field" id="ext" placeholder="Ext">
                          </div>
                        </div>
