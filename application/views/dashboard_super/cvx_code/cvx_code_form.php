  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <?php if(isset($cvx_code->cvx_code_id)){
        ?>
        <h2 class="title pull-left" id="form-title">Edit CVX Code </h2>
        <?php }else{ ?>
        <h2 class="title pull-left" id="form-title">Add CVX Code</h2>
        <?php }
        ?>
      </header>
      <?php echo form_open_multipart('dashboard_super/cvx_code/cvx_code/create','class="form-inner"') ?>
      <?php echo form_hidden('cvx_code_id',$cvx_code->cvx_code_id); ?>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          <label>CVX Code<span class="imp-red">*</span></label>
          <input type="text" required name="cvx_code" class="form-control text-field" value="<?php echo $cvx_code->cvx_code ?>" id="cvx_code" placeholder="CVX Code">
        </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."dashboard_super/cvx_code/cvx_code/"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
