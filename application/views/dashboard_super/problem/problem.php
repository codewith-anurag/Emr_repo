  ...
  <section class="box">
    <table class="table" style="border-bottom: 0.5px solid #c6c4c1;">
      <tbody>
        <tr>
          <td width="15%">
            <a href="<?php echo base_url("dashboard_super/problem/problem/create") ?>">
          ...
          <td width="15%">
            <a href="<?php echo base_url("dashboard_super/problem/problem/upload_problem") ?>">
              <button id="new" class="btn btn-default" style="width: 90%;margin-right: 11px;">
                <span class="fa fa-user"></span>
                &nbsp;&nbsp;Upload Problem</span>
              </button>
...
<td><span class="text-primary"><?php echo $value->problem_name; ?></span></td>
<!-- <td><span class="text-primary"><?php //echo $value->status; ?></span></td> -->

<td><select class="btn btn-default dropdown-toggle" onchange="call('<?php echo $value->problem_id; ?>',this.options[this.selectedIndex].value)">
...
<td>
  <div class="btn-group" style="float: right;display: flex;">
    <!-- <a href="#" onclick="admin_info('<?php //echo $value->allergy_id; ?>')" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-eye"></i></a> -->
                      <a  href="<?php echo base_url("dashboard_super/problem/problem/edit/$value->problem_id") ?>" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url("dashboard_super/problem/problem/delete/$value->problem_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?> ') "> <i class="fa fa-trash"></i></a>
                    </div>
  <!-- <a href="#" onclick="admin_info('<?php //echo $value->allergy_id; ?>')" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-eye"></i></a> -->
...
function call(id,value)
{
 //alert(value);
  ...
  if(changeStatus){
      $.ajax({
           url:'<?=base_url()?>dashboard_super/problem/problem/changestatus',
           ...
           success: function(msg){
             ...
             $("#h").text("problem status has been "+v);
          //   alert(msg);
    $('#active').modal('toggle');
            // alert(msg);
   ...
   setTimeout(function() {
        ...
        window.location="<?=base_url()?>dashboard_super/problem/problem";
    }, 3000);
}
