  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <h2 class="title pull-left" id="form-title">Add Allergy Code</h2>
      </header>
      <?php echo form_open_multipart('dashboard_super/allergy/allergy/upload_allergy','class="form-inner"') ?>
      
        <div class="row ml-10 mr-10">        
            <div class="col-12 col-md-3 form-group">
              <label>Allergy Code File<span class="imp-red">*</span></label>
              <input type="file" required=""  name="allergy_codefile" class=" text-field"  id="allergy_codefile">
            </div>
        </div>
