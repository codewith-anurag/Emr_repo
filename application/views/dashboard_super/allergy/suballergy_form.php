  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <?php if(isset($allergy->allergy_id)){
        ?>
        <h2 class="title pull-left" id="form-title">Edit Allergy </h2>
        <?php }else{ ?>
        <h2 class="title pull-left" id="form-title">Add Allergy</h2>
        <?php }
        ?>
      </header>
      <?php echo form_open_multipart('dashboard_super/allergy/allergy/suballergycreate','class="form-inner"') ?>
      <?php echo form_hidden('allergy_id',$allergy->allergy_id); ?>
      <div class="row ml-10 mr-10">
        <!-- <div class="col-12 col-md-12 form-group">
          <label>Allergy<span class="imp-red">*</span></label>
          <select name="parent_id" class="form-control w-33">
            <?php //foreach($parent_category as $value){ ?>
            <option value="<?php //echo $value->allergy_id; ?>"  <?php  //echo ($value->allergy_id==$allergy->parent_id)?'selected':''; ?> ><?php //echo $value->allergy_name; ?></option>
          <?php //} ?>
          </select>
        </div> -->
        <div class="col-12 col-md-12 form-group">
          <label>Allergy Name<span class="imp-red">*</span></label>
          <input type="text" required name="allergy_name" class="form-control text-field w-33" value="<?php echo $allergy->allergy_name ?>" id="allergy_name" placeholder="Allergy Name">
        </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."dashboard_super/allergy/allergy/"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
