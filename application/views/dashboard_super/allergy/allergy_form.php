...
<div class="col-lg-12 p-0">
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      ...
      <?php echo form_open_multipart('dashboard_super/allergy/allergy/create','class="form-inner"') ?>
      ...
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          ...
          <input type="text" required name="allergy_name" class="form-control text-field" value="<?php echo $allergy->allergy_name ?>" id="allergy_name" placeholder="Allergy Name">
        </div>
