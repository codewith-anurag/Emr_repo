...
<div class="col-lg-12 p-0">
  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      ...
      <?php echo form_open_multipart('dashboard_super/cpt_code/cpt_code/upload_cptcode','class="form-inner"') ?>
      
        <div class="row ml-10 mr-10">        
            <div class="col-12 col-md-3 form-group">
              <label>CPT Code File<span class="imp-red">*</span></label>
              <input type="file" required=""  name="cpt_codefile" class=" text-field"  id="cpt_codefile">
            </div>
        </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."dashboard_super/cpt_code/cpt_code/"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
