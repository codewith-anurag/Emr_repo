    ...
    <div class="col-lg-12 col-xs-12 p-0">
        <section>
            <header class="panel_header">
				<?php if (isset($cpt_code->cpt_id)) {
					?>
                    <h2 class="title pull-left" id="form-title">Edit CPT Code </h2>
				<?php } else { ?>
                    <h2 class="title pull-left" id="form-title">Add CPT Code</h2>
				<?php }
				?>
            </header>
			<?php echo form_open_multipart('dashboard_super/cpt_code/cpt_code/create', 'class="form-inner"') ?>
			<?php echo form_hidden('cpt_id', $cpt_code->cpt_id); ?>
            <div class="row ml-10 mr-10">
                <div class="col-12 col-md-3 form-group">
                    <label>CPT Code<span class="imp-red">*</span></label>
                    <input type="text" required name="cpt_code" class="form-control text-field"
                           value="<?php echo $cpt_code->cpt_code ?>" id="cpt_code" placeholder="CPT Code">
                </div>
