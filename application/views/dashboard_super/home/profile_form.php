    ...
    <div class="col-lg-8">
        <div  class="panel panel-default thumbnail" style="padding: 0px;border: 0px solid #ddd;">
            <div class="panel-heading no-print" style="margin-bottom:10px">
                <div class="btn-group">
                    <a class="btn btn-primary" href="<?php echo base_url("dashboard_super/home/profile") ?>"> <i class="fa fa-list"></i>  <?php echo display('profile') ?> </a>
                </div>
            </div>
				<!-- MAIN CONTENT AREA STARTS -->
				<div class="col-lg-8" style="width: 100%;margin-right: 2%;border: 1px solid #e8e8e8;padding-left: 13px;">
                        <div class="col-lg-12 col-xs-12" style="margin-top: -15px;">
                            <section class="box">
                                ...
                                <div class="row">
                                  <?php echo form_open_multipart('dashboard_super/home/form/','class="form-inner"') ?>
									...
									<div class="row form-row">
										<div class="col-xs-12">
											<div class="form-group">
											<div class="col-xs-4">
												<label class="form-label" for="picture"><?php echo display('logo') ?></label>
											</div>
											<div class="col-xs-8">
									...
									<div class="row form-row">
										<div class="col-xs-12">
											<div class="form-group">
											<div class="col-xs-4">
												<label class="form-label" for="img-thumbnail">Old Logo</label>
											</div>
											<div class="col-xs-8">
													<img src="<?php echo base_url($doctor->picture) ?>" alt="Picture" class="img-thumbnail" style="width:150px;">
													<a href="<?php echo base_url();?>dashboard_super/home/delete_profile_pic/<?php echo $doctor->user_id;?>" class="btn btn-xs btn-danger" onclick="return confirm('Are You Sure ?') "> <i class="fa fa-trash"></i></a>
												</div>
											</div>
										</div>
									</div>
