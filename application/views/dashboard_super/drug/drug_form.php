  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <?php if(isset($drug->drug_id)){
        ?>
        <h2 class="title pull-left" id="form-title">Edit Drug </h2>
        <?php }else{ ?>
        <h2 class="title pull-left" id="form-title">Add Drug</h2>
        <?php }
        ?>
      </header>
      <?php echo form_open_multipart('dashboard_super/drug/drug/create','class="form-inner"') ?>
      <?php echo form_hidden('drug_id',$drug->drug_id); ?>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          <label>Drug<span class="imp-red">*</span></label>
          <input type="text" required name="drug_name" class="form-control text-field" value="<?php echo $drug->drug_name ?>" id="drug" placeholder="Drug">
        </div>
    ...
    <div class="mb-10 mt-10 ml-10">
      ...
      <a href ="<?php echo base_url()."dashboard_super/drug/drug/"; ?>" ><button type="button" class="btn btn-default">Close</button></a>
    </div>
  </form>
</section>
</div>
