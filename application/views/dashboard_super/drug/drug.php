  ...
  <section class="box">
    <table class="table" style="border-bottom: 0.5px solid #c6c4c1;">
      <tbody>
        <tr>
          <td width="15%">
            <a href="<?php echo base_url("dashboard_super/drug/drug/create") ?>">
          ...
          <td width="15%">
            <a href="<?php echo base_url("dashboard_super/drug/drug/upload_drugname") ?>">
              <button id="new" class="btn btn-default" style="width: 90%;margin-right: 11px;">
                <span class="fa fa-user"></span>
                &nbsp;&nbsp;Upload drug</span>
              </button>
...
<td  ><span class="text-primary"><?php echo $value->drug_name; ?></span></td>
<td><select class="btn btn-default dropdown-toggle" onchange="call('<?php echo $value->drug_id; ?>',this.options[this.selectedIndex].value)">
...
<td>
  <div class="btn-group" style="float: right;display: flex;">
    <!-- <a href="#" onclick="admin_info('<?php //echo $value->allergy_id; ?>')" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-eye"></i></a> -->
                      <a  href="<?php echo base_url("dashboard_super/drug/drug/edit/$value->drug_id") ?>" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url("dashboard_super/drug/drug/delete/$value->drug_id") ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?> ') "> <i class="fa fa-trash"></i></a>
                    </div>
  <!-- <a href="#" onclick="admin_info('<?php //echo $value->allergy_id; ?>')" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-eye"></i></a> -->
...
function call(id,value)
{
 //alert(value);
  ...
  if(changeStatus){
      $.ajax({
           url:'<?=base_url()?>dashboard_super/drug/drug/changestatus',
   ...
   setTimeout(function() {
        ...
        window.location="<?=base_url()?>dashboard_super/drug/drug";
    }, 3000);
}
