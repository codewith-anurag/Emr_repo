...
<div class="col-lg-12 p-0">
  <div class="col-lg-12 col-xs-12 p-0">
    ...
    <section>
      ...
      <?php echo form_open_multipart('dashboard_super/drug/drug/upload_drugname','class="form-inner"') ?>
    
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          <label>Drug<span class="imp-red">*</span></label>
          <input type="file" required=""  name="drug_namefile" class=" text-field"  id="drug_namefile">
        </div>
      </div>
