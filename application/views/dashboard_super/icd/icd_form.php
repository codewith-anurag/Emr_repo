  ...
  <div class="col-lg-12 col-xs-12 p-0">
    <section>
      <header class="panel_header">
        <?php if(isset($icd->icd_id)){
        ?>
        <h2 class="title pull-left" id="form-title">Edit Icd </h2>
        <?php }else{ ?>
        <h2 class="title pull-left" id="form-title">Add Icd</h2>
        <?php }
        ?>
      </header>
      <?php echo form_open_multipart('dashboard_super/icd/icd/create','class="form-inner"') ?>
      <?php echo form_hidden('icd_id',$icd->icd_id); ?>
      <div class="row ml-10 mr-10">
        <div class="col-12 col-md-3 form-group">
          <label>Icd Name<span class="imp-red">*</span></label>
          <input type="text" required name="icd_name" class="form-control text-field" value="<?php echo $icd->icd_name ?>" id="icd_name" placeholder="Icd Name">
        </div>
