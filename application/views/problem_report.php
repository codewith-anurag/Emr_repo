        ...
        <tr>
          ...
          <td width="15%">
            ...
            <div style="display: flex;">
                ...
                <a onclick="return problem_report_pdf();">
                 ...
                 <button id="new" onclick="return problem_report_excel();" class="btn btn-default dropdown-toggle" style="width: 90%;margin-right: 11px;margin-top: 5px;" data-toggle="dropdown" data-hover="dropdown">
          ...
          <td>
                ...
                <div class="col-lg-3 form-group">
                    ...
                    <div class="">
                        ...
                        <select name="problem_report_problem" class="form-control problem_report_problem text-field select2">
                            ...
                            ?>
                                ...
                                <option value="<?php echo $problem_list->problem_name;?>"><?php echo $problem_list->problem_name;?></option>
               ...
               <div class="col-lg-3">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" name="from_date" class="form-control text-field" id="problem_report_from_datetime" placeholder="From Date">          
                ...
                <div class="col-lg-3">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" name="to_date" class="form-control text-field" id="problem_report_to_datetime" placeholder="To Date">          
               ...
               <div class="col-lg-3">
                   ...
                   <div class="form-group">                        
                        ...
                        <button id="new" class="btn btn-default" onclick="return problem_report_search();"><i class="fa fa-search"></i></button>    
      ...
      <table class="table table_problem_report">
        ...
        <thead>
            ...
            <tr>
                ...
                <th width="30%" class="text-center">Problem</th>
...
<script>    
 ...
 $(document).ready(function() {
    ...
    function problem_report_search(){

       var BASE_URL = '<?php echo base_url(); ?>';

       var problem = $(".problem_report_problem").val();
       ...
       var to_date = $("#problem_report_to_datetime").val();
          ...
          $("#padd").empty();
           ...
           $.ajax({
                ...
                url: BASE_URL+"problem_report/problem_report_search",

                data: 'problem='+problem+'&from_date='+from_date+'&to_date='+to_date,
    ...
    function problem_report_pdf(){
        ...
        window.location.href='<?php echo base_url(); ?>'+'problem_report/problem_report_pdf/'+problem+'/'+from_date+'/'+to_date



    }

     function problem_report_excel(){
        var problem = $(".problem_report_problem").val();        
        if ($("#problem_report_from_datetime").val()!="") {
            var from_date = $("#problem_report_from_datetime").val();
        }else{
        ...
        window.location.href='<?php echo base_url(); ?>'+'problem_report/download_excel/'+problem+'/'+from_date+'/'+to_date
