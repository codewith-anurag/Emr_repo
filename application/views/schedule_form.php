                        ...
                        <?php echo form_open('schedule/create','class="form-inner"') ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input name="start_time" class="timepicker form-control"   type="time" placeholder="<?php echo display('start_time') ?>" value="<?php echo $schedule->start_time ?>">
                                        </div>
                                        <div class="col-xs-6">
                                            <input name="end_time" class="timepicker form-control" type="time" placeholder="<?php echo display('end_time') ?>"  value="<?php echo $schedule->end_time ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-xs-3 col-form-label">Date  <?php //echo display('available_time') ?> </label>
                                <div class="col-xs-9">
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <input name="date" class="form-control"    type="date" placeholder="<?php //echo display('start_time') ?>" value="<?php //echo $schedule->start_time ?>">
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input class="timepicker-hour-min-only form-control" step="1" name="per_patient_time" type="time" placeholder="<?php echo display('per_patient_time') ?>" id="per_patient_time"  value="<?php echo $schedule->per_patient_time ?>">
                                </div>
                            </div>
