            ...
            <!-- <td>
                ...
                <td class="pt-15">
                    <div class="btn-group" style="float: right;display: flex;">
                      ...
                      <a href="<?php echo base_url("patient/edit_familymember/$familymember->member_id/$familymember->patient_id") ?>" class="btn btn-xs icon-box" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url("patient/delete_familymember/$familymember->member_id/$familymember->patient_id")?>" class="btn btn-xs btn-danger icon-box" onclick="return confirm('<?php echo display('are_you_sure') ?>')" style="margin-right:10px;"><i class="fa fa-trash"></i></a>
