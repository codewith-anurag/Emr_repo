...
<div class="col-lg-12 p-0">
                    ...
                    <section>
                        ...
                        <div class="row ml-10 mr-10">
                          ...
                          <div class="col-12 col-md-3 form-group">
                            ...
                            <input type="text" id="fname" name="fname" class="form-control text-field" value="<?php echo $patient->fname ?>"  placeholder="First Name">
                          </div>
                          <div class="col-12 col-md-3 form-group">
                            <label>Middle Name</label>
                            <input type="text" name="mname" class="form-control text-field"  value="<?php echo $patient->mname ?>" placeholder="Middle Name(optional)">
                          </div>
                          ...
                          <div class="col-12 col-md-2 form-group">
                            ...
                            <input type="text" name="previousfname" class="form-control text-field" value="<?php echo $patient->previousfname ?>"  placeholder="First Name">
                          </div>
                           <div class="col-12 col-md-3 form-group">
                            <label></label>
                            <input type="text" name="previousmname" class="form-control text-field" value="<?php echo $patient->previousmname ?>"  placeholder="Middle Name">
                          </div>
                           <div class="col-12 col-md-2 form-group">
                            <label></label>
    ...
    <div class="col-12 col-md-3 form-group">
        <label>DATE OF BIRTH<span class="imp-red">*</span></label>
         <input type="text" name="date_of_birth" value="<?php echo $patient->date_of_birth ?>" data-date-format='yyyy-mm-dd'  class="form-control text-field" id="dob">  <!--max="<?php //echo date('Y-m-d'); ?>"-->
      </div>
      <div class="col-12 col-md-3 form-group">
        <label>DATE OF DEATH</label>
      <?php  if(isset($patient->id)){ ?>
         <input type="text" name="dod" value="<?php echo $patient->dod; ?>" data-date-format='yyyy-mm-dd'  class="form-control text-field" id="dods"> <!--max="<?php //echo date('Y-m-d'); ?>"-->
       <?php }else{ ?>
         <input type="text" name="dod" value=""  class="form-control text-field" id="dod"> <!--max="<?php //echo date('Y-m-d'); ?>" -->
<?php       } ?>
      </div>
        <div class="col-12 col-md-2 form-group">
...
Patient doesn't have an email address
                        ...
                        <div class="row ml-10 mr-10">
                          ...
                          <div class="col-12 col-md-3 form-group">
                            <label></label>
                            <input type="number" name="ext" onkeydown="return event.keyCode !== 69" value="<?php echo $patient->ext ?>" class="form-control text-field" id="ext" placeholder="Ext">
                          </div>
                        </div>
                        ...
                        <div class="row ml-10 mr-10">
                          ...
                          <div class="col-12 col-md-6 form-group">
                            <label></label>
                            <input type="text" name="city" class="form-control text-field" value="<?php echo $patient->city ?>"  placeholder="City">
                          </div>
                        </div>
                           <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-6 form-group">
                            <input type="text" name="state" class="form-control text-field" value="<?php echo $patient->state ?>"  placeholder="State">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <input type="text" name="country" class="form-control text-field" value="<?php echo $patient->country ?>"  placeholder="Country">
                          </div>
                          <div class="col-12  col-md-2 form-group">
                            <input type="number" name="zip" class="form-control text-field" value="<?php echo $patient->zip ?>" id="zip" placeholder="Zip">
                          </div>
                        </div>
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-7 form-group">
                            <label>PREFERRED METHOD OF COMMUNICATION</label>
                            <select class="form-control" name="methodofcommunication" >
...
<!-- <a href="#" class="ml-10 mb-10">Learn more about collecting patient consent for your practice</a> -->
                       ...
                       <h2 class="title pull-left bg-light-grey" id="form-title">Primary Care Provider</h2>
                        ...
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-6 form-group">
                            <label>ADDRESS</label>
                            <input type="text" name="primary_address_1" value="<?php echo $patient->primary_address_1; ?>" class="form-control text-field"  placeholder="Street address">
                          </div>
                          <div class="col-12 col-md-6 form-group">
                            <label></label>
                              <input type="text" name="primary_city" value="<?php echo $patient->primary_city; ?>" class="form-control text-field"  placeholder="City">
                          </div>
                        </div>
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-6 form-group">
                            <input type="text" name="primary_state" value="<?php echo $patient->primary_state; ?>" class="form-control text-field"  placeholder="State">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                    ...
                    <div class="row ml-10 mr-10">
                      <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" name="guarantor_fname" value="<?php echo $patient->guarantor_fname ?>" class="form-control text-field"  placeholder="First Name">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <label></label>
                            <input type="text" name="guarantor_mname" value="<?php echo $patient->guarantor_mname ?>" class="form-control text-field"  placeholder="Middle Name">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <label></label>
                    ...
                    <div class="row ml-10 mr-10">
                      <div class="col-12 col-md-6 form-group">
                            <label>ADDRESS</label>
                            <input type="text" name="guarantor_address1" value="<?php echo $patient->guarantor_address1 ?>" class="form-control text-field"  placeholder="Street Address 1">
                          </div>
                          <div class="col-12 col-md-6 form-group">
                            <label></label>
                          <input type="text" name="guarantor_city" value="<?php echo $patient->guarantor_city ?>" class="form-control text-field"  placeholder="City">
                          </div>
                        </div>
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-6 form-group">
                            <input type="text" name="guarantor_state" value="<?php echo $patient->guarantor_state ?>" class="form-control text-field"  placeholder="State">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <input type="text" name="guarantor_country" value="<?php echo $patient->guarantor_country ?>" class="form-control text-field"  placeholder="Country">
                          </div>
                          <div class="col-12 col-md-2 form-group">
                    ...
                    <div class="row ml-10 mr-10">
                      <div class="col-12 col-md-4 form-group">
                            ...
                            <?php  if(isset($patient->id)){ ?>
                            <input type="text" name="guarantor_dob" data-date-format='yyyy-mm-dd'   value="<?php echo $patient->guarantor_dob ?>" class="form-control text-field" id="DOB">
                          <?php }else{ ?>
                            <input type="text" name="guarantor_dob" data-date-format='yyyy-mm-dd'   value="" class="form-control text-field" id="DOB"> <!--max="<?php //echo date('Y-m-d', strtotime("-1 days")); ?>"-->
                          <?php } ?>
                          </div>
                        <div class="col-12 col-md-3 form-group">
                          <label>SEX</label>
          ...
          <div class="col-12 col-md-5 form-group">
                    ...
                    <div class="row ml-10 mr-10 mb-10">
                        <div class="col-12 col-md-4 form-group">
                          ...
                          <div class="col-12 col-md-2 form-group">
                            <label></label>
                            <input type="number" name="guarantor_secondary_ext" onkeydown="return event.keyCode !== 69" value="<?php echo $patient->guarantor_secondary_ext ?>" class="form-control text-field" id="ext" placeholder="Ext">
                          </div>
                    </div>
                    ...
                    <div class="row ml-10 mr-10">
                      <div class="col-12 col-md-6 form-group">
                        <label>ADDRESS</label>
                        <input type="text" name="primary_address_1" value="<?php //echo $patient->primary_address_1 ?>" class="form-control text-field"  placeholder="Street address 1">
                      </div>
                      <div class="col-12 col-md-6 form-group">
                        <label></label>
                          <input type="text" name="primary_city" value="<?php //echo $patient->primary_city ?>" class="form-control text-field"  placeholder="City">
                    ...
                    <div class="row ml-10 mr-10">
                      ...
                      <div class="col-12 col-md-4 form-group">
                        <input type="text" name="primary_state" value="<?php //echo $patient->primary_state ?>" class="form-control text-field"  placeholder="Country">
                      </div>
                      <div class="col-12 col-md-2 form-group">
...
White
                    ...
                    <div class="row ml-10 mr-10 mb-10">
                      ...
                      <div class="col-12 col-md-3 form-group">
                        <label>IMMUNIZATION REGISTRY STATUS</label>
                            <select class="form-control" name="immunization_registery_status"  placeholder="status" >
                                                <option value="">Select</option>
                          ...
                          <div class="col-12 col-md-3 form-group">
                            ...
                            <input type="text" value="<?php echo $patient->immunization_effective_date ?>" data-date-format='yyyy-mm-dd'  name="immunization_effective_date" class="form-control text-field" id="edate">
                          </div>
                           <div class="col-12 col-md-6 form-group">
                        <label>IMMUNIZATION REGISTRY NOTIFICATION PREFERENCES</label>
                            <select class="form-control" name="reminder_call"  placeholder="state" >
                                                <option value="">Select</option>
       ...
       <input class="form-check-input" type="radio" name="data_privacy"  value="Yes, protect the data. Client (or guardian) has indicated that the information shall be protected." <?php echo ($patient->data_privacy=='Yes, protect the data. Client (or guardian) has indicated that the information shall be protected.')?'checked':''; ?> >
    ...
    <div class="col-12">
                      <div class="form-check dis-flex">
       <input class="form-check-input" type="radio" name="data_privacy"  value="No, it is not necessary to protect data from other clinicians. Client (or guardian) has indicated that the information does not need to be protected." <?php echo ($patient->data_privacy=='No, it is not necessary to protect data from other clinicians. Client (or guardian) has indicated that the information does not need to be protected.')?'checked':''; ?> >
        <label class="form-check-label ml-10" for="exampleRadios1">
      ...
      <div class="row form-row">
        <div class="col-xs-12">
          <div class="form-group">
            <div class="col-xs-8">
              <img src="<?php echo base_url($patient->picture) ?>" alt="Picture" class="img-thumbnail" style="width:100px;" />
              <a href="<?php echo base_url();?>patient/delete_profile_pic/<?php echo $patient->id;?>" class="btn btn-xs btn-danger" onclick="return confirm('Are You Sure ?') "> <i class="fa fa-trash"></i></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- image Crope -->
      ...
      <!-- image Crope -->
        ...
        <a href="<?php echo base_url().'patient'; ?>"><button type="button" class="btn btn-default mb-0">Close</button></a>
      </div>
      </form>
                    </section>
                </div>
  ...
  <div class="row ml-10 mr-10">
    <div class="col-12 col-md-6 form-group">
                           ...
                           <div class="col-12 col-md-6 form-group">
                            ...
                            <input type="text" name="plan_name_and_type" class="form-control text-field"  placeholder="plan name and type">
                            <!-- <i class="fa fa-search pos-icon"></i> -->
                          </div>
                          <div class="col-12">
 ...
 <div class="col-12 col-md-6 form-group">
  ...
  <div class="row  ml-10 mr-10">
     <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" onchange="effective()" name="effective_from"   class="form-control text-field" id="efdate" placeholder="EFFECTIVE FROM">  <!--max="<?php //echo date('Y-m-d', strtotime("-1 days")); ?>"-->
                          </div>
                           <div class="col-12 col-md-4 form-group">
  ...
  <div class="row  ml-10 mr-10">
    ...
    <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="number" onkeydown="return event.keyCode !== 69" name="copay_amount" class="form-control text-field" id="amount" placeholder="$">
                          </div>
                           <div class="col-12 col-md-4 form-group">
                      ...
                      <header class="panel_header" data-toggle="collapse" data-target="#employer">
                        ...
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-6 form-group">
                            ...
                            <input type="text" name="employer_address1" class="form-control text-field"  placeholder="Address 1">
                          </div>
                          <div class="col-12 col-md-6 form-group">
                            <label></label>
                            <input type="text" name="employer_address2" class="form-control text-field"  placeholder="Address 2">
                          </div>
                        </div>
                        <div class="row ml-10 mr-10 mb-10">
                          <div class="col-12 col-md-6 form-group">
                            <input type="text" name="city" class="form-control text-field"  placeholder="City">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <input type="text" name="state" class="form-control text-field"  placeholder="State">
                          </div>
                           <div class="col-12 col-md-2 form-group">
                        ...
                        <div class="row ml-10 mr-10">
                           <div class="col-12 col-md-4 form-group">
                            ...
                            <input type="text" name="subscribers_fname" class="form-control text-field"  placeholder="Subscriber First Name">
                          </div>
                          <div class="col-12 col-md-4 form-group">
                            <label></label>
                            <input type="text" name="subscribers_mname" class="form-control text-field"  placeholder="Middle Initial">
                          </div>
                           <div class="col-12 col-md-4 form-group">
                        ...
                        <div class="row ml-10 mr-10">
                          <div class="col-12 col-md-6 form-group">
                            ...
                            <input type="text" data-date-format='yyyy-mm-dd' name="subscribers_dob"  class="form-control text-field " id="sdate">
                          </div>
                               <div class="col-12 col-md-6 form-group">
                        <label>SEX</label>
      ...
      <div class="modal-footer">
          <button type="button" onclick="add_insurance()" class="btn btn-default mb-0" >Save</button>
