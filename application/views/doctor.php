    ...
    <table class="table" style="border-bottom: 0.5px solid #c6c4c1;">
      <tbody>
        ...
        <ul style="display:flex;list-style-type:none;">
            <li>
            <a href="<?php echo base_url().'doctor/doctor_report'; ?>">
              <button id="new" class="btn btn-default" style="width: 90%;margin-right: 11px;">
          ...
          <li>
          <a href="<?php echo base_url().'doctor/download_excel'; ?>">
            <button id="new" class="btn btn-default" style="width: 90%;margin-right: 11px;">
          ...
          <td>
            <div style="position: absolute; /*left: 1em; top: 0;*/ padding-top: 7px;" > <span id="searchButtonShow" class="text-primary hover icon-md fa fa-search" aria-hidden="true"  style="margin-left: 1px;position:relative;left:26px;"></span>
            </div>
        ...
        <tbody id='dadd'>
          ...
          <tr style="border-bottom: 1px solid #ddd;" class="hovertr">
            <td onclick="doctor_info('<?php echo $doctor->user_id; ?>')">
              <img width="60px" src="<?php echo ($doctor->picture!='')?base_url().$doctor->picture:base_url()."assets/images/patient/2017-01-16/p5.png"; ?>">
...
<td class="text-primary" onclick="doctor_info('<?php echo $doctor->user_id; ?>')"><?php echo date('d/m/Y',strtotime($doctor->date_of_birth)); ?> </td>
<td class="text-primary" onclick="doctor_info('<?php echo $doctor->user_id; ?>')"><?php echo $doctor->sex; ?></td>
          ...
          //     }
            ...
            <td class="pt-15"><div class="btn-group" style="float: right;display: flex;">
              <a href="#" onclick="doctor_info('<?php echo $doctor->user_id; ?>')" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-eye"></i></a>
                                <a  href="<?php echo base_url("doctor/edit/$doctor->user_id") ?>" class="btn btn-xs btn-default" style="margin-right:10px;"><i class="fa fa-edit"></i></a>
